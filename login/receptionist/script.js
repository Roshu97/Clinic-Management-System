  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (role === 'receptionist') {
        ...
        errorMessage.textContent = 'Access Denied: You are not authorized to access the receptionist portal.';
        // Optionally, sign out the user if they are not a receptionist
        auth.signOut();
      }
    } catch (error) {
